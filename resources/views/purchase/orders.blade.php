...
<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-0.5 text-sm text-slate-500 dark:text-slate-400">All purchase orders created from suppliers</p>
        </div>
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4 flex-wrap">
            ...
            <label for="orders-search" class="sr-only">Search by order no or supplier name</label>
            <input type="text" id="orders-search" name="search" placeholder="Order no / Supplier name…"
    ...
    <div class="rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 p-4">
        <div class="flex flex-col sm:flex-row sm:items-end gap-3 sm:gap-4">
            ...
            <div class="w-full sm:w-44">
                <label for="filter-order-status" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Order Status</label>
                <select id="filter-order-status" name="order_status" class="w-full rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 px-4 py-2.5 text-sm text-slate-900 dark:text-slate-100 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 outline-none">
    ...
    <div class="rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 overflow-hidden">
        <div class="overflow-x-auto max-h-[calc(100vh-20rem)] overflow-y-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-slate-200 dark:divide-slate-700" id="purchase-orders-body">
                    @php
                        $sampleOrders = [
                            ['order_no' => 'PO-2025-0042', 'order_date' => '05 Feb 2025', 'supplier' => 'Ahmed Khan', 'total' => 95000, 'expected_date' => '12 Feb 2025', 'status' => 'open'],
                            ['order_no' => 'PO-2025-0041', 'order_date' => '04 Feb 2025', 'supplier' => 'Khan Trading Co', 'total' => 145000, 'expected_date' => '10 Feb 2025', 'status' => 'pending'],
                            ['order_no' => 'PO-2025-0040', 'order_date' => '03 Feb 2025', 'supplier' => 'Agri Supplies Ltd', 'total' => 52000, 'expected_date' => '08 Feb 2025', 'status' => 'completed'],
                            ['order_no' => 'PO-2025-0039', 'order_date' => '02 Feb 2025', 'supplier' => 'Green Valley Ag', 'total' => 78000, 'expected_date' => '09 Feb 2025', 'status' => 'pending'],
                            ['order_no' => 'PO-2025-0038', 'order_date' => '01 Feb 2025', 'supplier' => 'Ahmed Khan', 'total' => 32000, 'expected_date' => '—', 'status' => 'cancelled'],
                        ];
                    @endphp
        ...
        <div id="purchase-orders-empty-state" class="hidden p-12 text-center">
            <div class="max-w-md mx-auto">
                ...
                <h3 class="text-lg font-semibold text-slate-900 dark:text-white mb-2">No purchase orders found</h3>
                <p class="text-sm text-slate-500 dark:text-slate-400">Purchase orders will appear here.</p>
            </div>
        </div>
