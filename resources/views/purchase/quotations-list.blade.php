...
@section('page-title', 'Purchase Quotations List')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h2 class="text-lg font-semibold text-slate-900 dark:text-white">Purchase Quotations List</h2>
            <p class="mt-0.5 text-sm text-slate-500 dark:text-slate-400">All supplier quotations for purchase</p>
        </div>
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4 flex-wrap">
            ...
            <label for="quotations-list-search" class="sr-only">Search by quotation no or supplier name</label>
            <input type="text" id="quotations-list-search" name="search" placeholder="Quotation no / Supplier name…"
    ...
    <div class="rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 overflow-hidden">
        <div class="overflow-x-auto max-h-[calc(100vh-20rem)] overflow-y-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-slate-200 dark:divide-slate-700" id="quotations-list-body">
                    @php
                        $sampleList = [
                            ['quotation_no' => 'PQ-2025-0092', 'quotation_date' => '06 Feb 2025', 'supplier' => 'Ahmed Khan', 'total' => 98000, 'valid_till' => '18 Feb 2025', 'valid_near' => false, 'status' => 'open'],
                            ['quotation_no' => 'PQ-2025-0091', 'quotation_date' => '05 Feb 2025', 'supplier' => 'Khan Trading Co', 'total' => 152000, 'valid_till' => '09 Feb 2025', 'valid_near' => true, 'status' => 'open'],
                            ['quotation_no' => 'PQ-2025-0090', 'quotation_date' => '04 Feb 2025', 'supplier' => 'Agri Supplies Ltd', 'total' => 54000, 'valid_till' => '12 Feb 2025', 'valid_near' => false, 'status' => 'converted'],
                            ['quotation_no' => 'PQ-2025-0089', 'quotation_date' => '03 Feb 2025', 'supplier' => 'Green Valley Ag', 'total' => 81000, 'valid_till' => '07 Feb 2025', 'valid_near' => true, 'status' => 'open'],
                            ['quotation_no' => 'PQ-2025-0088', 'quotation_date' => '02 Feb 2025', 'supplier' => 'Ahmed Khan', 'total' => 45000, 'valid_till' => '02 Feb 2025', 'valid_near' => true, 'status' => 'expired'],
                            ['quotation_no' => 'PQ-2025-0087', 'quotation_date' => '01 Feb 2025', 'supplier' => 'Khan Trading Co', 'total' => 120000, 'valid_till' => '15 Jan 2025', 'valid_near' => true, 'status' => 'converted'],
                        ];
                    @endphp
                    @foreach ($sampleList as $index => $q)
                        @php
                        ...
                        <tr class="{{ $rowClass }}">
                            ...
                            <td class="px-4 py-3 text-center">
                                ...
                                @elseif($q['status'] == 'converted')
                                    <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-semibold bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-500/20">Converted</span>
                                @else
                                    <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-semibold bg-slate-100 dark:bg-slate-600/50 text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-500/30">Expired</span>
                                @endif
                            </td>
        ...
        {{-- Empty State --}}
        <div id="quotations-list-empty-state" class="hidden p-12 text-center">
            <div class="max-w-md mx-auto">
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400">Supplier quotations will appear here for comparison and tracking.</p>
            </div>
        </div>
        ...
        <div class="px-4 py-3 border-t border-slate-200 dark:border-slate-700 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <p class="text-sm text-slate-600 dark:text-slate-400">
                Showing <span class="font-medium text-slate-900 dark:text-slate-100">1</span> to <span class="font-medium text-slate-900 dark:text-slate-100">6</span> of <span class="font-medium text-slate-900 dark:text-slate-100">6</span> results
            </p>
