...
<div class="space-y-6">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h2 class="text-lg font-semibold text-slate-900 dark:text-white">Payment Reminders</h2>
            <p class="mt-0.5 text-sm text-slate-500 dark:text-slate-400">Payment and outstanding reminders (UI only)</p>
        </div>
    ...
    <div class="rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 p-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="flex flex-col sm:flex-row sm:items-end gap-2">
                <label for="n_pay_from" class="text-sm text-slate-600 dark:text-slate-400 whitespace-nowrap">From</label>
                <input type="date" id="n_pay_from" class="rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 px-3 py-2 text-sm focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 outline-none">
            </div>
            <div class="flex flex-col sm:flex-row sm:items-end gap-2">
                <label for="n_pay_to" class="text-sm text-slate-600 dark:text-slate-400 whitespace-nowrap">To</label>
                <input type="date" id="n_pay_to" class="rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 px-3 py-2 text-sm focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 outline-none">
            </div>
            <div>
                <label for="n_pay_status" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Status</label>
                <select id="n_pay_status" class="w-full rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 px-4 py-2.5 text-sm focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 outline-none">
    ...
    <div class="rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 divide-y divide-slate-200 dark:divide-slate-700">
        <label class="flex gap-3 px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-800/50 cursor-pointer">
            ...
            <div class="flex-1 min-w-0">
                ...
                <p class="text-sm text-slate-600 dark:text-slate-400 truncate">Outstanding Rs 28,500 from Green Agri.</p>
                <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5">03 Feb 2025, 4:00 PM</p>
            </div>
        ...
        <label class="flex gap-3 px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-800/50 cursor-pointer bg-slate-50/50 dark:bg-slate-800/30">
            ...
            <div class="flex-1 min-w-0">
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400 truncate">Rs 45,200 received for INV-1001 (Farm Co).</p>
                <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5">02 Feb 2025, 11:20 AM</p>
            </div>
    ...
    <div class="px-4 py-2 text-sm text-slate-600 dark:text-slate-400">Showing 1 to 2 of 7 (dummy)</div>
</div>
@endsection
