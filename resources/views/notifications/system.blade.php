...
<div class="space-y-6">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h2 class="text-lg font-semibold text-slate-900 dark:text-white">System Notifications</h2>
            <p class="mt-0.5 text-sm text-slate-500 dark:text-slate-400">System and app alerts (UI only)</p>
        </div>
    ...
    <div class="rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 p-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="flex flex-col sm:flex-row sm:items-end gap-2">
                <label for="n_sys_from" class="text-sm text-slate-600 dark:text-slate-400 whitespace-nowrap">From</label>
                <input type="date" id="n_sys_from" class="rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 px-3 py-2 text-sm focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 outline-none">
            </div>
            <div class="flex flex-col sm:flex-row sm:items-end gap-2">
                <label for="n_sys_to" class="text-sm text-slate-600 dark:text-slate-400 whitespace-nowrap">To</label>
                <input type="date" id="n_sys_to" class="rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 px-3 py-2 text-sm focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 outline-none">
            </div>
            <div>
                <label for="n_sys_status" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Status</label>
                <select id="n_sys_status" class="w-full rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 px-4 py-2.5 text-sm focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 outline-none">
    ...
    <div class="rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 divide-y divide-slate-200 dark:divide-slate-700">
        <label class="flex gap-3 px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-800/50 cursor-pointer">
            ...
            <div class="flex-1 min-w-0">
                <p class="text-sm font-semibold text-slate-900 dark:text-white">App update available</p>
                <p class="text-sm text-slate-600 dark:text-slate-400 truncate">New version 2.1 is ready to install.</p>
                <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5">04 Feb 2025, 8:00 AM</p>
            </div>
        ...
        <label class="flex gap-3 px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-800/50 cursor-pointer bg-slate-50/50 dark:bg-slate-800/30">
            ...
            <div class="flex-1 min-w-0">
                <p class="text-sm font-medium text-slate-700 dark:text-slate-300">Backup completed</p>
                <p class="text-sm text-slate-500 dark:text-slate-400 truncate">Daily backup finished successfully.</p>
                <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5">03 Feb 2025, 3:00 AM</p>
            </div>
    ...
    <div class="px-4 py-2 text-sm text-slate-600 dark:text-slate-400">Showing 1 to 2 of 6 (dummy)</div>
</div>
@endsection
