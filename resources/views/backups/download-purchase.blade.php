...
@section('title', 'Download Purchase Data as CSV / Excel')
@section('page-title', 'Download Purchase Data')

@section('content')
<div class="space-y-6">
    <div>
        <h2 class="text-lg font-semibold text-slate-900 dark:text-white">Download Purchase Data</h2>
        <p class="mt-0.5 text-sm text-slate-500 dark:text-slate-400">Export purchase data as CSV or Excel (UI only)</p>
    </div>
