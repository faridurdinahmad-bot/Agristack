    ...
    <div class="flex flex-col flex-grow lg:rounded-2xl m-0 lg:m-4 lg:mr-0 rounded-none border-r border-slate-200/80 dark:border-slate-700/50 lg:border border-white/60 dark:border-slate-700/50 bg-slate-50 dark:bg-slate-800/95 backdrop-blur-xl lg:bg-white/80 dark:lg:bg-slate-800/80 shadow-xl shadow-slate-200/50 dark:shadow-slate-900/50 overflow-hidden min-h-full lg:min-h-0">
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
            ...
            <details class="group" {{ $current('app.settings.*') ? 'open' : '' }}>
                ...
                <ul class="mt-1 ml-4 pl-4 border-l border-slate-200 dark:border-slate-600 space-y-0.5">
                    <li><a href="{{ route('app.settings.general') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-sm {{ $current('app.settings.general') ? 'text-emerald-600 dark:text-emerald-400 font-medium' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100/80 dark:hover:bg-slate-700/50' }}">⚙️ General Settings</a></li>
                    ...
                    <li><a href="{{ route('app.settings.user-roles') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-sm {{ $current('app.settings.user-roles') ? 'text-emerald-600 dark:text-emerald-400 font-medium' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100/80 dark:hover:bg-slate-700/50' }}">👥 User &amp; Roles</a></li>
                    <li><a href="{{ route('app.settings.notifications') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-sm {{ $current('app.settings.notifications') ? 'text-emerald-600 dark:text-emerald-400 font-medium' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100/80 dark:hover:bg-slate-700/50' }}">🔔 Notification Settings</a></li>
                    <li><a href="{{ route('app.settings.tax-invoice') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-sm {{ $current('app.settings.tax-invoice') ? 'text-emerald-600 dark:text-emerald-400 font-medium' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100/80 dark:hover:bg-slate-700/50' }}">📄 Tax &amp; Invoice</a></li>
                    <li><a href="{{ route('app.settings.backup-sync') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-sm {{ $current('app.settings.backup-sync') ? 'text-emerald-600 dark:text-emerald-400 font-medium' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100/80 dark:hover:bg-slate-700/50' }}">💾 Backup &amp; Sync</a></li>
                    <li><a href="{{ route('app.settings.appearance') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-sm {{ $current('app.settings.appearance') ? 'text-emerald-600 dark:text-emerald-400 font-medium' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100/80 dark:hover:bg-slate-700/50' }}">🎨 Appearance</a></li>
                </ul>
            </details>
